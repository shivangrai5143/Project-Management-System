        ...
        <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className={`relative w-14 h-8 rounded-full transition-colors ${settings.enabled ? 'bg-indigo-500' : 'bg-slate-600'}`}
                        >
                            <div className={`absolute top-1 w-6 h-6 rounded-full bg-white shadow-lg transition-transform ${settings.enabled ? 'left-7' : 'left-1'}`} />
                        </button>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className={`relative w-14 h-8 rounded-full transition-colors ${settings.autoSuggest ? 'bg-indigo-500' : 'bg-slate-600'}`}
                        >
                            <div className={`absolute top-1 w-6 h-6 rounded-full bg-white shadow-lg transition-transform ${settings.autoSuggest ? 'left-7' : 'left-1'}`} />
                        </button>
                    </div>
                    ...
                    <div className="pt-4 border-t border-slate-700/50">
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${gitHubConnected
            ...
            <Card padding="lg">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button
                        onClick={toggleTheme}
                        className={`relative w-14 h-8 rounded-full transition-colors ${isDark ? 'bg-indigo-500' : 'bg-slate-600'}`}
                    >
                        <div className={`absolute top-1 w-6 h-6 rounded-full bg-white shadow-lg transition-transform ${isDark ? 'left-7' : 'left-1'}`} />
                    </button>
                </div>
            </Card>
